...
var timelineObj = gsap.timeline({defaults:{duration:45}})
  ...
  .fromTo('.orb4b',  {xPercent:-50, yPercent:-25},{motionPath:{
    ...
    //start: 1.41,
    //end: 1.6
  }, ease:'none', yoyo:true, repeat:-1, duration: 10}, 'orbs')
  ...
  .add(function(){
    $('.c1_line4').on('mousemove', function(e){
